                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      Text("UBIT Hub", style: TextStyle(fontSize: 20, color: eleBtnColor, fontWeight: FontWeight.w900),),
                    ],
                  ),
                  SizedBox(height: 20),
                  Text("Welcome Back", style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900 ),),
                  SizedBox(height: 10),
                  Text("Please enter your details to sign in", style: TextStyle(color: textColor, fontSize: 15),),
                  SizedBox(height:40),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("Forgot Password?", style: TextStyle(color: eleBtnColor, fontWeight: FontWeight.bold,))
                    ],
                  ),
                  SizedBox(height: 5),
                  TextField(
                  ...
                  }, icon: is_ObscureText ? Icon(Icons.visibility_off,color:  subTextColor,): Icon(Icons.visibility_off,color:  subTextColor )),
                  hintText: "Password",
                 hintStyle: const TextStyle(color:  subTextColor)
                  ),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                    Checkbox(value: is_checked, onChanged: (bool?value){
                      setState(() {
                  ...
                  ElevatedButton(onPressed: (){
                    setState(() {
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> MainDahboard()));
                    });
                  }, child: 
                  Row(
                  ...
                  [
                    ...
                    Icon(Icons.arrow_forward, color: Colors.white, size: 25,)
                     ...
                     Row(
                      ...
                      TextButton(onPressed: (){}, child: Text("Create an account", style: TextStyle(color: eleBtnColor, fontWeight: FontWeight.bold),))
                      ]
                     ),
                ]
              ),
